...
const ModelPage = () => {
    ...
    const sendTranscript = async () => {
        ...
        try {
            ...
            await axios.post("http://127.0.0.1:9000/ChangeSentenceFunction", transcript, {
                headers: { "Content-Type": "text/plain" }
            });

            const response = await axios.get("http://127.0.0.1:9000/isl_gloss");
            console.log("Server Response:", response.data);
            setIslText(response.data.isl);

            const videoResponse = await axios.get("http://127.0.0.1:9000/videos");
