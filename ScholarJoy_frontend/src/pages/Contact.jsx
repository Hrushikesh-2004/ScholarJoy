...
const Contact = () => {
          ...
          <div>
            ...
            <ul className="mt-6 space-y-4">
              <li className="flex items-center gap-3 text-slate-700">
                <Mail className="h-5 w-5 text-blue-500" /> support@signbridge.ai
              </li>
              <li className="flex items-center gap-3 text-slate-700">
                <Phone className="h-5 w-5 text-blue-500" /> +1 (234) 567-890
              </li>
              <li className="flex items-center gap-3 text-slate-700">
                <Clock className="h-5 w-5 text-blue-500" /> Monday - Friday, 9 AM - 6 PM (EST)
              </li>
            </ul>
          </div>
        </div>
  ...
  <CardContent>
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <Button type="submit" className="w-full bg-blue-500 hover:bg-purple-400 text-white py-3">
